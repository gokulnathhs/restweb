...
<body>
    ...
    <main>
        <section class="banner" style="background-image: url('images\ 1.jpeg');">
            <h2 class="offer-txt">40% Off This Weekend</h2>
        ...
        <section class="features">
            <div class="feature">
                <h3>Our New Menu</h3>
                <img src="ima 2.jpg" alt="Our New Menu">
                <p>Hotel New Desh’s new burger dish is a delicious, juicy creation featuring a beef patty, melted cheese, fresh lettuce, and tangy pickles on a sesame bun, served with crispy fries. It's a perfect choice for a hearty, flavorful meal.</p>
                <a href="www.google.com">See our new menu</a>
            </div>
            <div class="feature">
                <h3>Book a table</h3>
                <img src="book.jpg" alt="Book a table">
                <p>Book a table online at Hotel New Desh and enjoy a hassle-free dining experience! Visit our website [hotel website link] or use our reservation app to secure your spot today."</p>
        ...
        <footer>
            <div class="logo">
                <img src="images.png" class="footer" alt="Little Lemon Logo">
...
```
## OUTPUT:
![Screenshot 2024-11-15 175921](https://github.com/user-attachments/assets/cbd68fbd-23cf-4a42-9fcb-c883f453c37a)
